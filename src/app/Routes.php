...
class Routes
{
     ...
     * @param callable|callable[] $callback Function that is expected to return object of type \VFramework\App\Response.
     ...
     */
    public function getResponse(\VFramework\App\Request $request)
    {
