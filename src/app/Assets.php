 ...
 * @event \VFramework\App\Assets\BeforeGetURLEvent beforeGetURL An event dispatched before the URL of the asset specified is created.
 * @event \VFramework\App\Assets\GetURLEvent getURL An event dispatched after the URL of the asset specified is created.
 * @event \VFramework\App\Assets\BeforePrepareEvent beforePrepare An event dispatched before the asset specified is prepared for returning (resized for example).
 * @event \VFramework\App\Assets\PrepareEvent prepare An event dispatched after the asset specified is prepared for returning (resized for example)
 * @event \VFramework\App\Assets\BeforeGetDetailsEvent beforeGetDetails An event dispatched before the details of the asset specified is created.
 * @event \VFramework\App\Assets\GetDetailsEvent getDetails An event dispatched after the details of the asset specified is created.
 */
class Assets
{
    ...
    /**
     *
     * @var \VFramework\App\DataRepository 
     */
    private $appData = null;

    /**
     *
     * @var \VFramework\App\URLs 
     */
    ...
    public function __construct(\VFramework\App $app)
    {
        ...
        $app->routes
            ->add($this->internalPathPrefix . '*', function (\VFramework\App\Request $request) {
     ...
     * @see VFramework\App
     * @see VFramework\App\DataRepository::validate
     * @see VFramework\App\DataRepository::set()
    ...
    private function optimizeDirs()
    {
        ...
        foreach ($this->dirs as $pathname) {
            $pathname = \VFramework\Internal\Utilities::normalizePath($pathname);
    ...
    public function getURL(string $filename, array $options = []): string
    {
        ...
        if ($this->hasEventListeners('beforeGetURL')) {
            $eventDetails = new \VFramework\App\Assets\BeforeGetURLEventDetails($filename, $options);
        ...
        if ($this->hasEventListeners('getURL')) {
            $eventDetails = new \VFramework\App\Assets\GetURLEventDetails($filename, $options, $url);
     ...
     * 
     * @param \VFramework\App\Request $request The request object to match against.
     * @return \VFramework\App\Response|null The response object for the request specified.
     */
    public function getResponse(\VFramework\App\Request $request): ?\VFramework\App\Response
    {
    ...
    private function prepare(string $filename, array $options = []): ?string
    {
        ...
        if ($this->hasEventListeners('beforePrepare')) {
            $eventDetails = new \VFramework\App\Assets\BeforePrepareEventDetails($filename, $options);
        ...
        if ($this->hasEventListeners('prepare')) {
            $eventDetails = new \VFramework\App\Assets\PrepareEventDetails($filename, $options, $result);
    ...
    public function getDetails(string $filename, array $list): array
    {
        ...
        if ($this->hasEventListeners('beforeGetDetails')) {
            $eventDetails = new \VFramework\App\Assets\BeforeGetDetailsEventDetails($filename, $list);
        ...
        if ($this->hasEventListeners('getDetails')) {
            $eventDetails = new \VFramework\App\Assets\GetDetailsEventDetails($filename, $list, $result);
