 ...
 * @property-read \VFramework\App\Request\Path $path The request path.
 * @property-read \VFramework\App\Request\Query $query The request query string.
 * @property-read \VFramework\App\Request\Headers $headers The request headers.
 * @property-read \VFramework\App\Request\Cookies $cookies The request cookies.
 * @property-read \VFramework\App\Request\FormData $formData The request POST data and files.
 */
class Request
{
                        ...
                        if ($initializeFromEnvironment && isset($_POST, $_FILES)) {
                            ...
                            foreach ($_FILES as $name => $value) {
                                if (is_uploaded_file($value['tmp_name'])) {
                                    ...
                                    $file = new \VFramework\App\Request\FormDataFileItem();
                                    $file->name = $name;
