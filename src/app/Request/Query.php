...
class Query
{
     ...
     * @return \VFramework\App\Request\QueryItem Returns a new query item.
     */
    public function make(string $name = null, string $value = null): \VFramework\App\Request\QueryItem
    {
        if ($this->newQueryItemCache === null) {
            $this->newQueryItemCache = new \VFramework\App\Request\QueryItem();
        }
     ...
     * Sets a query item.
     * 
     * @param \VFramework\App\Request\QueryItem $query item The query item to set.
     * @return self Returns a reference to itself.
     */
    public function set(\VFramework\App\Request\QueryItem $queryItem): self
    {
     ...
     * @return VFramework\App\Request\QueryItem|null The query item requested of null if not found.
     */
    public function get(string $name): ?\VFramework\App\Request\QueryItem
    {
     ...
     * 
     * @return \VFramework\DataList|\VFramework\App\Request\QueryItem[] An array containing all query items.
     */
