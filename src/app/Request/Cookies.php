...
class Cookies
{
     ...
     * @return \VFramework\App\Request\Cookie Returns a new cookie.
     */
    public function make(string $name = null, string $value = null): \VFramework\App\Request\Cookie
    {
        if ($this->newCookieCache === null) {
            $this->newCookieCache = new \VFramework\App\Request\Cookie();
        }
     ...
     * Sets a cookie.
     * 
     * @param \VFramework\App\Request\Cookie $cookie The cookie to set.
     * @return self Returns a reference to itself.
     */
    public function set(\VFramework\App\Request\Cookie $cookie): self
    {
     ...
     * @return VFramework\App\Request\Cookie|null The cookie requested of null if not found.
     */
    public function get(string $name): ?\VFramework\App\Request\Cookie
    {
     ...
     * 
     * @return \VFramework\DataList|\VFramework\App\Request\Cookie[] An array containing all cookies.
     */
