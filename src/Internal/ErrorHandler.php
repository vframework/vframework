...
class ErrorHandler
{
     ...
     */
    static function handleException(\VFramework\App $app, \Throwable $exception, array $options): void
    {
        $errors = [];
     ...
     * @return void No value is returned.
     */
    static function handleFatalError(\VFramework\App $app, array $errorData, array $options): void
    {
     ...
     * @return void No value is returned.
     */
    static private function handleErrors(\VFramework\App $app, array $errors, $options): void
    {
        $level = ob_get_level();
        for ($i = 0; $i < $level; $i++) {
            ob_end_clean();
